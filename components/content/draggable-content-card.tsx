...
import { Star, ExternalLink, Heart, MessageCircle, GripVertical } from "lucide-react"
  ...
  return (
    ...
    >
      <Card className="group overflow-hidden transition-shadow hover:shadow-lg">
        <div className="absolute left-2 top-2 z-10 rounded-lg bg-background/80 p-1 opacity-0 backdrop-blur-sm transition-opacity group-hover:opacity-100">
